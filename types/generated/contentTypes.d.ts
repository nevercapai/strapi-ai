...
export interface ApiBlogBlog extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    articleInfo: Schema.Attribute.Component<'shared.article-info', false>;
    category: Schema.Attribute.Enumeration<
      ['Tutorials', 'Podcasting', 'Content Creation', 'Business', 'AI Tips']
    >;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::blog.blog'> &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    TDK: Schema.Attribute.Component<'shared.tdk', false>;
    timeToRead: Schema.Attribute.Integer;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    urlTitle: Schema.Attribute.String;
    userInfo: Schema.Attribute.Component<'shared.user-info', false>;
  };
}
...
export interface ApiTanmaBlogTanmaBlog extends Struct.CollectionTypeSchema {
  collectionName: 'tanma_blogs';
  info: {
    displayName: 'TanmaBlog';
    pluralName: 'tanma-blogs';
    singularName: 'tanma-blog';
  };
  options: {
    draftAndPublish: true;
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::tanma-blog.tanma-blog': ApiTanmaBlogTanmaBlog;
